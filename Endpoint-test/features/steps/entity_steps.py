...
def step_endpoint_test_application_is_configured(context):
    assert context.endpoint_client is not None
...
def step_create_entity(context, name, description):
    ...
    context.create_response = context.endpoint_client.create_entity(name, description)
...
def step_entity_creation_should_succeed(context):
    ...
    entity = context.endpoint_client.response_json(context.create_response)
    assert entity["id"]
...
def step_fetch_created_entity(context):
    context.get_response = context.endpoint_client.get_entity(context.entity_id)
...
def step_fetched_entity_should_match(context):
    ...
    entity = context.endpoint_client.response_json(context.get_response)
...
def step_list_entities(context):
    context.list_response = context.endpoint_client.list_entities()
...
def step_created_entity_should_be_listed(context):
    ...
    entities = context.endpoint_client.response_json(context.list_response)
...
def step_update_entity_with_no_description(context, name):
    ...
    context.update_response = context.endpoint_client.update_entity(
        context.entity_id,
        name,
        None,
    )
...
def step_entity_update_should_succeed(context):
    ...
    entity = context.endpoint_client.response_json(context.update_response)
    assert entity["id"] == context.entity_id
    assert entity["name"] == context.expected_name
...
def step_delete_created_entity(context):
    context.delete_response = context.endpoint_client.delete_entity(context.entity_id)
...
def step_fetch_deleted_entity(context):
    context.deleted_get_response = context.endpoint_client.get_entity(context.entity_id)
